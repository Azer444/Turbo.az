        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IsDeleted = table.Column<bool>(nullable: false),
                    EngineVolumeName = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IsDeleted = table.Column<bool>(nullable: false),
                    GearName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CentralClosure = table.Column<bool>(nullable: false),
                    LeatherSalon = table.Column<bool>(nullable: false),
                    SeatVent = table.Column<bool>(nullable: false),
                    Abs = table.Column<bool>(nullable: false),
                    ParkRadar = table.Column<bool>(nullable: false),
                    XenonLamps = table.Column<bool>(nullable: false),
                    Lyuk = table.Column<bool>(nullable: false),
                    Conditioner = table.Column<bool>(nullable: false),
                    RearCamera = table.Column<bool>(nullable: false),
                    RainSensor = table.Column<bool>(nullable: false),
                    SeatHeating = table.Column<bool>(nullable: false),
                    SideCurtains = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Adverts_Fuels_FuelId",
                        column: x => x.FuelId,
                        principalTable: "Fuels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Adverts_Gears_GearId",
                        column: x => x.GearId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Adverts_FuelId",
                table: "Adverts",
                column: "FuelId");

            migrationBuilder.CreateIndex(
                name: "IX_Adverts_GearId",
                table: "Adverts",
                column: "GearId");
